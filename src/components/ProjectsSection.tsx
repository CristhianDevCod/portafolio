        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard 
                className="group overflow-hidden dark:border-purple-500/10 h-full flex flex-col border-purple-500/10 shadow-sm hover:bg-purple-500/10 hover:border-purple-500/30 hover:shadow-purple-500/20 hover:shadow-lg transition-all duration-300">
                ...
                <CardFooter className="flex justify-center md:justify-start items-center border-t border-border/30 bg-gradient-to-r from-purple-500/5 to-pink-500/5">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <GitHubIcon className="h-4 w-4 mr-2 group-hover/link:rotate-12 transition-transform duration-300" />
                    Ver en Proyecto 🔗
                  </motion.a>
                </CardFooter>
              </GlassCard>
