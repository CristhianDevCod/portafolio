...
function SkillTag({ skill, index }: { skill: string; index: number }) {
  return (
    <motion.div
      ...
      className="px-3 py-1 bg-muted/80 backdrop-blur-sm rounded-md text-sm border border-purple-500/10 shadow-sm hover:bg-purple-500/10 hover:border-purple-500/30 hover:shadow-purple-500/20 hover:shadow-lg transition-all duration-300 cursor-pointer"
    >
      {skill}
    </motion.div>
  );
