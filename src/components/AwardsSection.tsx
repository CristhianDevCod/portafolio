        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {awards.map((award, index) => (
            <MotionWrapper key={award.name + award.date} delay={index * 0.1}>
              <GlassCard className="p-4 dark:border-purple-500/10 flex flex-col h-full border-purple-500/10 shadow-sm hover:bg-purple-500/10 hover:border-purple-500/30 hover:shadow-purple-500/20 hover:shadow-lg transition-all duration-300">
